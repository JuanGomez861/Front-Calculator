...
export function Header({toggle,setToggle}) {
    ...
    const classNameHeader=`header ${toggle==2 ? 'header-theme-2':''}`
    const toggleClass=`toggle ${toggle==2 ?'toggle-theme-2':''}`
    const conatinerToggleClass=`toggle_container ${toggle==2 ?'t-c-theme-2':''} `
    return (
